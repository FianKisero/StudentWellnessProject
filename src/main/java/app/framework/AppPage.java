...
public class AppPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<style>");
        out.println(":root { --primary:#3cb371; --dark:#2e8b57; --light:#f0f8ff; }");
        ...
        out.println(".edit-btn{background:#2e8b57;}");
        out.println(".edit-btn:hover{background:#27ae60;}");
        out.println(".delete-btn{background:#7f8c8d;}");
        out.println(".delete-btn:hover{background:#95a5a6;}");
        ...
        out.println("<div class='logo'>Student Wellness | ");
